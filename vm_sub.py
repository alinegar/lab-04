...
def on_connect(client, userdata, flags, rc):
   ...
   client.subscribe("fernndez/ipinfo")
   client.subscribe("fernndez/time")
   client.subscribe("fernndez/date")
   client.message_callback_add("fernndez/ipinfo", on_message_from_ipinfo)
   client.message_callback_add("fernndez/time", on_message_from_time)
   client.message_callback_add("fernndez/date", on_message_from_date)
